...
function() {
    ...
    if (null != e)
        for (var t = 0; t < e.length; t++) {
            var n, o, a, l, i = e[t].dataset.countdown, r = e[t].querySelector(".countdown-days .countdown-value"), c = e[t].querySelector(".countdown-hours .countdown-value"), d = e[t].querySelector(".countdown-minutes .countdown-value"), s = e[t].querySelector(".countdown-seconds .countdown-value");
            if (i = new Date(i).getTime(),
            isNaN(i))
                return;
            setInterval(u, 1e3)
        }
...
jQuery().fancybox && ($.fancybox.defaults.image.preload = !1,
